...
//        participant.receivedPacketCounter.incrementAndGet();
  ...
  public boolean equals(Object o) {
    ...
    final RtpParticipant that = (RtpParticipant) o;
    return Objects.equal(this.controlDestination, that.controlDestination) &&
      Objects.equal(this.dataDestination, that.dataDestination);
  }

  @Override
  public int hashCode() {
    return Objects.hashCode(dataDestination, controlDestination);
  }

  @Override
  public String toString() {
    return Objects.toStringHelper(this)
      .add("datqDestination", dataDestination)
      .add("controlDestination", controlDestination)
      .add("lastDataOrigin", lastDataOrigin)
      .add("lastControlOrigin", lastControlOrigin)
      .add("lastReceptionInstant", lastReceptionInstant)
      .add("byeReceptionInstant", byeReceptionInstant)
      .add("lastSequenceNumber", lastSequenceNumber)
      .add("receivedSdes", receivedSdes)
      .add("receivedByteCounter", receivedByteCounter)
      .add("receivedPacketCounter", receivedPacketCounter)
      .add("validPacketCounter", validPacketCounter)
      .toString();
  }
}
